    ...
    <style>
        * {
        ...
        .navbar {
            ...
            padding: 12px 20px;
            border-radius: 10px;
            background: rgba(255, 255, 255, 0.06); /* subtle glass over gradient */
        ...
        /* Hover/focus */
        .btn-nav:hover, .btn-logout:hover,
        .btn-nav:focus, .btn-logout:focus {
            transform: translateY(-2px);
        ...
        @media (max-width: 720px) {
            ...
            .btn-nav, .btn-logout { padding: 6px 10px; font-size: 13px; }
        }
